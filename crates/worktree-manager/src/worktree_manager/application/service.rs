    ...
    B: BranchOperations,
{
    ...
    pub fn remove_worktree(
        ...
        self.repository.remove(repo_path, worktree_path, force)
    }
    ...
    pub fn lock_worktree(
        ...
        self.repository.lock(repo_path, worktree_path, reason)
    }

    /// Unlock a worktree
    pub fn unlock_worktree(&self, repo_path: &Path, worktree_path: &Path) -> DomainResult<()> {
        self.repository.unlock(repo_path, worktree_path)
    }
